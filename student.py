...
#         #====title====
#         title = Label(text="Manage Student Details", font=("goudy old style", 20, "bold"), bg="#330154", fg="white").place(x=10,y=15, width=1180, height=35)
...
#                     ))
#                     con.commit()
#                     messagebox.showinfo("Sucsess","Student added successfully", parent= self.root)
#                     self.show() 
...
class studentClass:
    def __init__(self, root):
        ...
        #====title====
        title = Label(text="Manage Student Details", font=("goudy old style", 20, "bold"), bg="#330154", fg="white")
