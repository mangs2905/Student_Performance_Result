...
#         #====title====
#         title = Label(text="Manage Course Details", font=("goudy old style", 20, "bold"), bg="#330154", fg="white").place(x=10,y=15, width=1180, height=35)
...
#         self.CourseTable.heading("desription", text="Description")
...
#                     ))
#                     con.commit()
#                     messagebox.showinfo("Sucsess","Course added successfully", parent= self.root)
#                     self.show() 
...
#             else:
#                 cur.execute("selct from * Course Name where name=?", (self.var_course.get(),))
#                 row = cur.fetchone()
#                 if row ==None:
...
class CourseClass:
    def __init__(self, root):
        ...
        #====title====
        title = Label(text="Manage Course Details", font=("goudy old style", 20, "bold"), bg="#330154", fg="white")
