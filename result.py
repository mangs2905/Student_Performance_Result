...
#         btn_clear = Button(self.root, text= "Clear", font=("times new roman", 15), bg="lightgreen", activebackground="lightgray", cursor="hand2", command=self.clear).place(x=430, y=420, width=120, height=35)
        
#         #======Image====
#         self.bg_img = Image.open("Images/bg_school.jpeg")
#         self.bg_img = self.bg_img.resize((50,300), Image.LANCZOS)
...
#     def add(self):
#         con = sqlite3.connect(database="SPR_db")
#         cur = con.cursor()
#         try:
...
#                     ))
#                     con.commit()
#                     messagebox.showinfo("Sucsess","Result added successfully", parent= self.root)
...
class resultClass:
    def __init__(self, root):
        ...
        # ====title====
        title = Label(self.root, text="Add Student Result", font=("goudy old style", 20, "bold"), bg="orange",
                      fg="#262626")
        ...
        lbl_marks = Label(self.root, text="Marks", font=("goudy old style", 20, "bold"), bg="white")
        ...
        self.txt_student.place(x=280, y=100, width=200)
        self.txt_student.set("Select")
        btn_search = Button(self.root, text="Search", font=("goudy old style", 15, "bold"), bg="#2196f3",
        ...
        btn_clear = Button(self.root, text="Clear", font=("times new roman", 15), bg="lightgreen",
